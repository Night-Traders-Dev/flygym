...
class FlightController:
    ...
    def step(self, move_direction=None, turn=0.0):
        ...
        # Wing animation disabled — actuator forces at 200Hz destabilize simulation.
        # Flight is purely via xfrc_applied. Wings stay in neutral pose.
        # TODO: add visual-only wing animation via direct qpos manipulation
